...
type GET_PRODUCTS_CATALOGUE = { type: "GET_PRODUCTS_CATALOGUE", payload: IProduct[] }
type GET_PRODUCT_QUESTIONS = { type: "GET_PRODUCT_QUESTIONS", payload: IQuestion[] }
type FILTER_PRODUCTS = { type: "FILTER_PRODUCTS", payload: string }
type ADD_PRODUCT_TO_CART = { type: "ADD_PRODUCT_TO_CART", payload: IProductCart }
...
export const productReducer = (state = INITIAL_STATE, action: GET_PRODUCTS_HOME | GET_PRODUCTS_CATALOGUE | GET_PRODUCT_QUESTIONS | FILTER_PRODUCTS | ADD_PRODUCT_TO_CART | DELETE_PRODUCT_CART | RESET_CART|STOP_SEARCH) => {
    switch (action.type) {
